...
public class ListableBeanFactoryImpl extends AbstractBeanFactory implements ListableBeanFactory {
	 ...
	 */
	public static final String DEFAULT_PREFIX = "com.interface21.beans.";
	...
	/** 
	 * Property suffix for references to other com.interface21.beans in the current
	...
	/**
	 * Prefix before values referencing other com.interface21.beans
	 */
	 ...
	 * in the map: e.g. 'com.interface21.beans.'
	...
	public String toString() {
		return getClass() + ": defined com.interface21.beans [" + StringUtils.arrayToDelimitedString(getBeanDefinitionNames(), ",") + "]";
	}
